...
namespace DriverHostapp.Frontend.HostappMainWindow{
    public partial class MainWindow : Window{
        ...
        public readonly SoftwareVersion FrontendVersion = new SoftwareVersion(
            majorVersion: 1,
            minorVersion: 1
        );
        ...
        private void ScanDevices(object sender, RoutedEventArgs args){
            if(this.TechnologyIndex is null){
                this.openMessageWindow("Communication technology is not chosen! (null)!");
                return;
            }
        ...
        //     if(this.TechnologyIndex is null){
        //         this.openMessageWindow("Communication technology is not chosen! (null)!");
        //         Logger?.Error("Communication technology is not chosen! (null)!");
        //         throw new ArgumentNullException();
        //     }
